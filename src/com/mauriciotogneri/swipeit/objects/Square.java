...
public class Square
{
	...
	private static final float FADE_RATE = 0.01f;
	...
	public void draw()
	{
		...
		if (this.alphaState == 1)
		{
			this.alpha += Square.FADE_RATE;
		}
		else if (this.alphaState == -1)
		{
			this.alpha -= Square.FADE_RATE;
		}
		...
		GLES20.glUniform4f(this.colorLocation, red, green, blue, this.alpha);
