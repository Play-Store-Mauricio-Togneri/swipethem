...
public class Renderer implements android.opengl.GLSurfaceView.Renderer
{
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config)
	{
		...
		this.square = new Square(this.positionLocation, this.colorLocation, Color.BLUE, 0, 0);
	...
	public void onSurfaceChanged(GL10 unused, int width, int height)
	{
		...
		Matrix.orthoM(this.projectionMatrix, 0, -Renderer.RESOLUTION_X / 2, Renderer.RESOLUTION_X / 2, -(Renderer.RESOLUTION_Y / 2), (Renderer.RESOLUTION_Y / 2), -1f, 1f);
	}
